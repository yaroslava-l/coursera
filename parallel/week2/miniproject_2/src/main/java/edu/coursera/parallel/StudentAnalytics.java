...
public final class StudentAnalytics {
    ...
    public String mostCommonFirstNameOfInactiveStudentsParallelStream(
        ...
        Optional<Map.Entry<String, Integer>> mostCommon = Arrays.stream(studentArray)
                .parallel()
                .filter(t -> !t.checkIsCurrent())
                .collect(Collectors.toMap(Student::getFirstName, t -> 1, (o, o2) -> o + o2))
    ...
    public int countNumberOfFailedStudentsOlderThan20ParallelStream(
        ...
        long count = Arrays.stream(studentArray)
                .parallel()
                .filter(t -> !t.checkIsCurrent() && t.getAge() > 20 && t.getGrade() < 65)
                .count();
        return (int) count;
    }
}
